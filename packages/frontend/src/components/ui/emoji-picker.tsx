	...
	return (
		...
		>
			...
			<EmojiPickerPrimitive.Search
				className="outline-hidden placeholder:text-foreground flex h-10 w-full rounded-md bg-transparent py-3 text-sm disabled:cursor-not-allowed disabled:opacity-50"
...
function EmojiPickerCategoryHeader({ category, ...props }: EmojiPickerListCategoryHeaderProps) {
	return (
		<div
			{...props}
			className="bg-popover text-foreground px-3 pb-2 pt-3.5 text-xs leading-none"
